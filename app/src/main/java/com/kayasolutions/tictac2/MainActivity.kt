package com.kayasolutions.tictac2
...
import com.kayasolutions.tictac2.R
...
class MainActivity : android.support.v7.app.AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        setContentView(com.kayasolutions.tictac2.R.layout.activity_main)
    ...
    protected  fun btnClick(view: android.view.View){
        val buSelected= view as android.widget.Button
        var cellID=0
        when(buSelected.id){
            com.kayasolutions.tictac2.R.id.btn1-> cellID=1
            com.kayasolutions.tictac2.R.id.btn2-> cellID=2
            com.kayasolutions.tictac2.R.id.btn3-> cellID=3
            com.kayasolutions.tictac2.R.id.btn4-> cellID=4
            com.kayasolutions.tictac2.R.id.btn5-> cellID=5
            com.kayasolutions.tictac2.R.id.btn6-> cellID=6
            com.kayasolutions.tictac2.R.id.btn7-> cellID=7
            com.kayasolutions.tictac2.R.id.btn8-> cellID=8
            com.kayasolutions.tictac2.R.id.btn9-> cellID=9
    ...
    fun PlayGame(cellID:Int,buSelected:Button){
        ...
        if(ActivePlayer==1){
            buSelected.text="X"
            buSelected.setBackgroundResource(R.color.darkblue)
            player1.add(cellID)
            ActivePlayer=2
    ...
    protected fun requestGame(view:android.view.View){
    ...
    protected fun acceptGame(view:android.view.View){
        var userDemail=etEmail.text.toString()
        myRef.child("Users").child( SplitString(userDemail)).child("Request").push().setValue(myEmail)
